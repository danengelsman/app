      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center space-x-8">
            ...
            <Link to="/agents" className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md">
              Agents
            </Link>
            <Link to="/topics" className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md">
              Topics
            </Link>
            <Link to="/content" className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md">
              Content
            </Link>
            <Link to="/branding" className="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md">
              Branding
            </Link>
          </div>
        </div>
