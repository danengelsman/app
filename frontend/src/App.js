    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-blue-800">API Status Update</h3>
            <div className="mt-1 text-sm text-blue-700">
              <p>
                MiniMax has updated their voice cloning system to Speech-02 series. While we work on implementing 
                the new API structure, you can still register voice IDs and use them with available default voices 
